...
public static partial class TraceRay
{
    ...
    /// </summary>
    public static CGameTrace TraceShape(Vector origin, Vector end, TraceMask mask, ulong content, IntPtr skip)
    {
    ...
    /// </summary>
    public static CGameTrace TraceShape(Vector origin, Vector end, ulong mask, Contents content, IntPtr skip)
    {
    ...
    /// Performs a trace from origin to end with specified mask and content flags
    /// </summary>
    public static CGameTrace TraceShape(Vector origin, Vector end, TraceMask mask, Contents content, IntPtr skip)
    {
    ...
    /// </summary>
    public static CGameTrace TraceShape(Vector origin, Vector end, Contents mask, ulong content, IntPtr skip)
    {
        return TraceShape(origin, end, (ulong)mask, content, skip);
    }
    ...
    /// Performs a trace from origin to end with specified mask and content flags
    /// </summary>
    public static CGameTrace TraceShape(Vector origin, Vector end, Contents mask, Contents content, IntPtr skip)
    {
        return TraceShape(origin, end, (ulong)mask, (ulong)content, skip);
    }
    ...
    /// </summary>
    public static CGameTrace TraceShape(Vector origin, Vector end, Contents content, IntPtr skip)
    {
    ...
    /// </summary>
    public static CGameTrace TraceShape(Vector origin, Vector end, TraceMask mask, IntPtr skip)
    {
    ...
    /// </summary>
    public static CGameTrace TraceShape(Vector origin, Vector end, ulong mask, IntPtr skip)
    {
    ...
    /// </summary>
    public static CGameTrace TraceShape(Vector origin, Vector end, TraceMask mask, TraceMask content, IntPtr skip)
    {
        return TraceShape(origin, end, (ulong)mask, (ulong)content, skip);
    }
    ...
    /// </summary>
    public static CGameTrace TraceShape(Vector origin, Vector end, Contents mask, TraceMask content, IntPtr skip)
    {
        return TraceShape(origin, end, (ulong)mask, (ulong)content, skip);
    }
